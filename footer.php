<div class="f-widget"><!--footer Widget-->
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4"><!--footer newsletter widget-->
					<div class="title-widget-bg">
						<div class="title-widget">Bize katıl</div>
					</div>
					<div class="newsletter">
						...
						<form role="form">
							<div class="form-group">
								<label>E- mail gir ve başla</label>
								<input type="email" class="form-control newstler-input" id="exampleInputEmail1" placeholder="e-mail">
								<button class="btn btn-default btn-red btn-sm">Kayıt olmak istiyorum</button>
							</div>
						</form>
					</div>
	...
	<div class="footer"><!--footer-->
		<div class="container">
			<div class="row">
				<div class="col-md-9">
					<ul class="footerkullanici"><!--footer nav-->
					...
					<div class="f-credit">&copy;<?php echo $ayarcek['ayar_author'];?><a href="https://www.farfarco.com/"> farfarco.com</a></div>
				...
				<div class="col-md-3"><!--footer Share-->
					...
					<div class="fsoc">
						...
						<a href="http://<?php echo $ayarcek['ayar_google'];?>" class="fflickr">flickr</a>
						
						<a href="http://<?php echo $ayarcek['ayar_youtube'];?>" class="ffeed">feed</a>
