<?php
//her sayfada olmak zorunda oturum olan
ob_start();
session_start();
include '../netting/baglan.php';
//belirli veriyi çekme işlemi - ayar sayfasından header a
...
//belirli veriyi çekme işlemi - kullanici sayfasından header a
      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          <div class="navbar nav_title" style="border: 0;">
            <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>Farfarco TV</span></a>
          </div>
